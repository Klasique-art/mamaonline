...
const Hero = () => {
  return (
    ...
    >
      ...
      <img src={drone1} alt="futuristic drone." className=' absolute bottom-[90px] -right-[50px] rounded-lg w-[250px] h-[200px]' draggable="false" />
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className='ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'>
            ...
            <span className='text-gradient'>online</span> <br className='sm:block hidden' /> {" "}
          </h1>
      ...
      <div className="flex-1">
        <img src={droneWelcome} alt="futuristic drones flying over the city with packages." className='w-[90%] mt-4 sm:mt-0 mx-auto sm:mx-[unset] sm:w-full h-full relative z-[5] rounded-lg' />
