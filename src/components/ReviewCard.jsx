...
const ReviewCard = ({img, name, text}) => {
  return (
    <div className="flex items-center p-2  gap-2 md:gap-4 border-gradient rounded-md min-w-full xs:min-w-80 h-40 snap-center select-none feedback-card" data-aos="fade-up" tabIndex="0">
