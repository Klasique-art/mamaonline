...
const TestimonialCard = ({msg, img, name, subText, ...otherProps}) => {
  return (
    <div {...otherProps}>
      <div tabIndex="0" className='text-white border-gradient py-6 px-4 w-full sm:w-72 md:w-96 rounded-[20px] flex flex-col gap-3 sm:gap-5 feedback-card'>
        ...
        <div className="w-full flex items-center gap-2">
          <figure className='w-[50px] md:w-[60px] h-[50px] md:h-[60px] rounded-full'>
            <img src={img} alt="person" className='rounded-full w-full h-full'  />
          </figure>
          <div className="">
